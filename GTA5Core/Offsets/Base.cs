...
public struct Base
{
    ...
    public const int SessionSwitchType = 1575036;           // NETWORK::NETWORK_SESSION_SET_UNIQUE_CREW_LIMIT(1);

    // Vehicle Menus Globals
    public const int oVMCreate = 2696456;                   // Create any vehicle. STREAMING::REQUEST_MODEL(Global_2696456.f_27.f_66);
    public const int oVMYCar = 2739811;                     // Get my car. HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
