...
public static class OnlineData
{
    ...
    {
        new OnlineInfo(){ Name="请求弹药空投", Value=917 },       // NETWORK::NETWORK_IS_SCRIPT_ACTIVE("AM_AMMO_DROP", -1, true, 0)
        new OnlineInfo(){ Name="请求重型防弹装甲", Value=927 },    // NETWORK::NETWORK_IS_SCRIPT_ACTIVE("AM_AMMO_DROP", PLAYER::PLAYER_ID(), true, 0)
        new OnlineInfo(){ Name="请求牛鲨睾酮", Value=925 },       // NETWORK::NETWORK_IS_SCRIPT_ACTIVE("AM_BRU_BOX", PLAYER::PLAYER_ID(), true, 0)
        new OnlineInfo(){ Name="请求船只接送", Value=918 },       // NETWORK::NETWORK_IS_SCRIPT_ACTIVE("AM_BOAT_TAXI", PLAYER::PLAYER_ID(), true, 0)
        new OnlineInfo(){ Name="请求直升机接送", Value=919 },      // NETWORK::NETWORK_IS_SCRIPT_ACTIVE("AM_HELI_TAXI", -1, true, 0)
    };
