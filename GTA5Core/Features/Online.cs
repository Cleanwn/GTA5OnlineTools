...
public static class Online
{
    ...
    {
        Globals.Set_Global_Value(Base.oVMYCar + 4522, isEnable ? 1 : 0);   // SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("am_backup_heli")
    }
    ...
    {
        Globals.Set_Global_Value(Base.oVMYCar + 4523, isEnable ? 1 : 0);   // SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("am_airstrike")
    }
    ...
    {
        Globals.Set_Global_Value(Base.oVMYCar + 6995, isEnable ? 1 : 0);                 // if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
    }
    ...
    {
        Globals.Set_Global_Value(Base.oVMYCar + 6996, isEnable ? 1 : 0);
    }
    ...
    public static async void RequestKosatka()
    {
        ...
        Globals.Set_Global_Value(Base.oVMYCar + 991, 1);
    }
    ...
    /// </summary>
    /// <param name="isEnable"></param>
    public static void KosatkaMissleRange(bool isEnable)
    {
        Globals.Set_Global_Value(Tunables.Index(RAGE.JOAAT("IH_SUBMARINE_MISSILES_DISTANCE")), isEnable ? 99999 : 4000);
    }
}
